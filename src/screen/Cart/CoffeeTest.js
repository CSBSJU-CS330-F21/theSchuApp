    ...
    const renderProducts = () => (
        <> 
                ...
                {products.map((product, index) => (
                  ...
                  <Button onPress={()=>addToCart(product)} title="button">Add to cart</Button>
                  </View>
              ))} </>
    );
    ...
    const renderCart = () => (
      ...
      <Text>Cart:</Text>
                {cart.map((product, index) => (
                  ...
                  <Button onPress={()=>addToCart(product)} title="button">Add to cart</Button>
                  <Button title='remove' onPress={()=>removeFromCart(product)}>Remove</Button>
                  </View>
              ))}
        ...
        return (
            <ScrollView>
              ...
              <Text>{page=== PAGE_CART && renderCart()}</Text>
                ...
                <View>
                  <Button onPress={() => navigateTo(PAGE_CART)} title="cart">Go to Cart</Button>
                  <Text>{cart.length}</Text>
                </View>
                <View>
                  <Button onPress={() => navigateTo(PAGE_PRODUCTS)} title="products">Products</Button>
                  <Text>{cart.length}</Text>
                </View>
            </ScrollView>
